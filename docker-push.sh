...
then
  ...
  if [[ "$TRAVIS_BRANCH" == "staging" ]]; then
    ...
    export REACT_APP_USERS_SERVICE_URL="http://testdriven-staging-alb-1647171701.us-west-1.elb.amazonaws.com"
    export REACT_APP_EXERCISES_SERVICE_URL="http://testdriven-staging-alb-1647171701.us-west-1.elb.amazonaws.com"
