...
then
  ...
  if [[ "$TRAVIS_BRANCH" == "staging" ]]; then
    ...
    export REACT_APP_EXERCISES_SERVICE_URL="http://testdriven-staging-alb-1457912982.us-west-1.elb.amazonaws.com"
...
>>>>>>> adding dns name for application load balancer on AWS
